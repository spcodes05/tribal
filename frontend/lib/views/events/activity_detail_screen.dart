      ...
      builder: (context, ctrl, _) {
        ...
        return Scaffold(
          ...
          body: activity == null
              ...
              : _ActivityDetailBody(activity: activity, ctrl: ctrl),
        );
      },
    );
  }
...
class _ActivityDetailBody extends StatelessWidget {
  ...
  const _ActivityDetailBody({required this.activity, required this.ctrl});
    ...
    return Stack(
      children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (activity.meetingPoint.isNotEmpty)
                      _MeetingPointCard(meetingPoint: activity.meetingPoint),
                  ],
                ),
              ),
            ),
        ...
        Positioned(
          ...
          left: 0, right: 0,
          child: _BottomActions(activity: activity, ctrl: ctrl),
        ),
      ],
    );
  }
...
// ── Weather badge (stub — 22°C shown in the UI) ───────────────────────────────
...
class _MeetingPointCard extends StatelessWidget {
  ...
  const _MeetingPointCard({required this.meetingPoint});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          const SizedBox(width: 16),
          const Icon(Icons.location_pin, color: AppColors.primary, size: 28),
          const SizedBox(width: 12),
          Column(
